...
export class Webcam {
  ...
  startFront = async () => {
    ...
    this.webcamOptions = mergeObjects(this.webcamOptions, userFacingCam);
  ...
  startBack = async () => {
    ...
    this.webcamOptions = mergeObjects(this.webcamOptions, backCam);
  ...
  changeByDevice = async device => {
    this.webcamOptions = mergeObjects(this.webcamOptions, {
  ...
  changeOptions = async newOptions => {
    this.webcamOptions = mergeObjects(this.webcamOptions, newOptions);
